...
export function useMainContract() {
  ...
  const mainContract = useAsyncInitialize(async () => {
    ...
    // Address.parse("EQCPtFe3EUHIvnUOtvJeWnjPvkCGwi-Arguzb0QtgSM6vBI6") // replace with your address from tutorial 2 step 8
  ...
  return {
    ...
    sendWithdrawal: () => {
      return mainContract?.sendWithdrawalRequest(sender, toNano("0.05"), toNano("0.04"));
    }
  };
}
